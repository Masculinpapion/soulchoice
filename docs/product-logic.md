...
- **⚠️ AÇIK NETLİK (sonra ele alınacak — Mustafa 15.07):** `gift × invite/request` semantiği. Belge "hediyeni teslim al" diyor (owner = alıcı varsayımı) ama gift+invite'ta owner **veren** de olabilir. Link'i kim koyuyor / kim alıyor akışı ilan tipine göre değişebilir — ürün-netliği kararı bekliyor (simetri sorunu değil).
